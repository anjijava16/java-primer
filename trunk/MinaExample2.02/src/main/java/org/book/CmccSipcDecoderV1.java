 ...
 *	Hello World!
 */
public class CmccSipcDecoderV1 extends CumulativeProtocolDecoder {
	private final Charset charset;
	private final AttributeKey CONTEXT = new AttributeKey(getClass(), "context");

	public CmccSipcDecoderV1(Charset charset) {
	...
	protected boolean doDecode(IoSession session, IoBuffer in,
		...
		String statusLine = ctx.getStatusLine(), sender = ctx.getSender(), receiver = ctx
				.getReceiver(), length = ctx.getLength(), sms = ctx.getSms();
